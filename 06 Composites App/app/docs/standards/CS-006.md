...
| Ref | Document | Where |
|---|---|---|
| R1 | IN2 Infusion Resin TDS | `03 Datasheets/EC-TDS-IN2-Infusion-Resin.pdf` |
| R2 | IN2 + hardener SDS | `03 Datasheets/EC-SDS-IN2-Epoxy-Infusion-Resin-and-Hardener.pdf` |
| R3 | VB160 bagging film TDS/SDS | `03 Datasheets/EC-TDS-VB160-Vacuum-Bagging-Film.pdf`, `EC-SDS-VB160-Vacuum-Bagging-Film.pdf` |
| R4 | PP180 peel ply TDS | `03 Datasheets/EC-TDS-PP180-Peel-Ply.pdf` |
| R5 | Airtac 2 spray adhesive TDS/SDS | `03 Datasheets/airtac2imp.pdf`, `airtac2spray.pdf` |
...
![The full loop in section, pot to pump. The flow mesh stops 30–50 mm short of the outlet, the trap sits between bag and pump, and resin travel inlet to outlet stays at or under 0.5 m.](figures/cs006-infusion.png)
