...
| Ref | Document | Where |
|---|---|---|
| R1 | DP420 TDS (structural bonding prep) | `03 Datasheets/3m-scotch-weld-epoxy-adhesive-dp420-black.pdf` |
...
![Left: the sacrificial ply is the sanding budget; structural plies are not an allowance. Right: the catch-can failure, a machine sander on thin laminate at a taper, through the skin and into the substrate.](figures/cs009-sacrificial.png)
