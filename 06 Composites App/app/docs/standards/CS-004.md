...
CNC-machined polyurethane tooling-board molds (30–60 lb/ft³, Coastal Enterprises stock) used for resin infusion or wet layup. Not covered: 3D-printed compression molds (CS-006 Composites Appendix A) and hotwire foam male molds.

## 3. References

| Ref | Document | Where |
|---|---|---|
| R1 | XCR Epoxy Coating Resin TDS | `03 Datasheets/EC-TDS-XCR-Epoxy-Coating-Resin.pdf` |
| R2 | XCR SDS | `03 Datasheets/EC-SDS-XCR-Epoxy-Coating-Resin-Combined.pdf` |
| R3 | Partall Film #10 (PVA) guide + SDS | `03 Datasheets/PARTALL-Film-10.pdf`, `SDS-PF10-5.5-en-NA-2025-01-28.pdf` |
| R4 | Formula Five Mold Release Wax guide + SDS | `03 Datasheets/FORMULA-FIVE-Mold-Release-Wax.pdf`, `SDS-F5MRW-5.3-en-NA-2025-01-28.pdf` |
| R5 | Formula Five Clean 'N Glaze guide + SDS | `03 Datasheets/FORMULA-FIVE-Clean-N-Glaze.pdf`, `SDS-CG-5.3-en-NA-2025-01-28.pdf` |
...
![Top: everything that ends up on the mold surface, in order. Bottom: the XCR overcoat clock at 20 °C; the shaded span is the firm-but-tacky window where a second coat bonds with no prep.](figures/cs004-seal-stack.png)
