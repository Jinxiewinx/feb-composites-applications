...
| Ref | Document | Where |
|---|---|---|
| R1 | IN2 TDS · R2 XCR TDS · R3 West 105/205, /206, /209 TDS | `03 Datasheets/` (see INDEX.md) |
| R4 | SDS for all of the above | `03 Datasheets/` |
...
they publish it at. Every figure is quoted from a TDS in `03 Datasheets/`.
...
![Datasheet demould figure (solid) against the FEB hold that governs (full bar), per system, on one time axis. The holds land on shift boundaries, which is why both FAST systems still hold 24 h.](figures/cs008-holds.png)
...
how many hours short it was. The numbers live in one place, `06 Composites App/app/resins.js`,
