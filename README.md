...
| `10 Fusion Add-in/` | A Fusion 360 add-in that runs the stack planner from inside Fusion and draws the board layers over the mold. Feasibility study only so far, nothing built | `FEASIBILITY-PLAN.md` |
