...
Ten tabs, grouped in the sidebar by who is asking (Dashboard up top, then
Build, Planning, and Team):
...
![Parts: the index of every part beside the selected one, each stage a row of steps](03%20App/design/parts-mockup-20260825.png)
