...
| `app/` | A placeholder page proving hosting, the design tokens and the Firebase config are wired. `app/ds/` is `tokens.css`, `components.css` and the two fonts copied from `06 Design System/` |
