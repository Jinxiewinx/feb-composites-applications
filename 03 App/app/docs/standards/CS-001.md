...
![Figure 1. Label anatomy: class word, ID line with the R&D box, name, and the class's identifying fact, beside the QR code. The ID line is the only capped line, which is why the R&D mark lives there.](figures/cs001-label-anatomy.png)
...
![Figure 2. Where a mold's identity lives, and the two keep-out zones: never the working surface, never within 40 mm of the flange perimeter on either face.](figures/cs001-mold-identity.png)
