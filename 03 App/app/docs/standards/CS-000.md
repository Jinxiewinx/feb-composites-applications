...
![Figure 1. The status lifecycle. A document enters CS-INDEX at first draft and never leaves; Retired is an end state, deletion is not one.](figures/cs000-lifecycle.png)
