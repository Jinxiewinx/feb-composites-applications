...
2. Resin math: mix ≈ fiber mass × 0.9 for hand layup. (Yes, that is more than the 60:40 target implies: the squeegee and the breather take the excess out, and the *cured part* lands near 60:40. Record mixed vs final masses on the WO to tune this factor.)
...
4. Wet out ply-by-ply per the WO ply table; squeegee each ply until shiny-wet, not swimming.
