...
![Figure 1. Z-zero, right and wrong. Left: touched off once per job at the highest point of the stock. Right: zeroed at the bed, where any error in assumed stack height is a plunge into the part.](figures/cs005-zzero.png)
