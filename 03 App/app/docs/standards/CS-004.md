...
![Figure 1. Top: everything that ends up on the mold surface, in order. Bottom: the XCR overcoat clock at 20 °C; the shaded span is the firm-but-tacky window where a second coat bonds with no prep.](figures/cs004-seal-stack.png)
