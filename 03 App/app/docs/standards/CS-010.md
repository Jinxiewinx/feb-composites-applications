...
![The mesh-in-stack path in plan: sheets overlapping ≥25 mm, a bare terminable tail at the grounding point, and the default probe pattern (100 mm grid plus edge midpoints). Every point measures to the grounding point; every point passes or the part does not.](figures/cs010-mesh-path.png)
