...
const SHOTS = [
  ...
  { id: "molds", kind: "app", badge: 5, vh: 1200,
    ...
    title: "Molds · molds, plans and boards on one screen",
    note: "Stock merged in: the rail indexes every mold, stack plan and tooling board; the pane is whatever is selected. Arrow keys walk the rail and 1 advances a mold's stage. Planning a mold creates its record at “Designed”, and the plan, drawings and cut list hang off it." },
  { id: "molds-overview", kind: "app", badge: 6, vh: 1100,
    js: `setTab("molds");`,
    title: "Molds · the season view",
    note: "With nothing selected, the pane answers the standing questions: where the live molds sit across the stages, how much board is on the rack by thickness and density, and whether the planned blanks actually fit what you own." },
  ...
  { id: "schedule-week", kind: "app", badge: 11, vh: 1100,
