...
const SHOTS = [
  ...
  { id: "season", kind: "app", badge: 2, vh: 950,
    ...
    note: "The Master Tracker sheet, in the app. One line per part the team means to make, most of them nearly empty by design \u2014 a line exists the moment somebody commits to building the thing, and the specifics arrive later. It is a read: name, subteam, the C/M/L rail the Parts index already draws, where the part has got to in a word, and its deadline. Around sixty parts on screen where eighteen fit before, and no sideways scroll at any width \u2014 thirteen editable columns had a floor near 1,700px against about 1,300px of room, so the old table scrolled at every width it was ever opened at. The name opens the part, which is where everything is edited and where the evidence gate and both confirms already live." },
