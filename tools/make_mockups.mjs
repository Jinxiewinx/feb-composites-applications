 ...
 */
const SHOTS = [
  { id: "dashboard", kind: "app", badge: 1, vh: 1180,
    js: `setTab("dashboard");`,
    title: "Dashboard · the pit board",
    note: "Four lanes, each a question: what is Stopped, what is Waiting on you, what is Due this week, and what is On the clock. A lane never disappears — an empty one answers in a sentence with a number in it, because \u201cnothing is blocked\u201d is worth reading at a Monday meeting and a hole in a grid is not. That is why the eleven-module board this replaced could leave gaps: five of its areas could render nothing at all. Each lane header is its own numeral, attached to the thing it counts, so the alert strip that used to say the same numbers one row above is gone. Waiting on you is the new part — it walks the buy-off gate ladder in the order the button walks it, so it never offers a signature the button then refuses, and for somebody with no trainings yet it says which one would unlock the most work and who holds it. Under the lanes the program and the shop's footer sit side by side, so each reads as a list down a column rather than a line strung across the page. Team lore keeps its own surface inside the footer \u2014 it is the one thing down there that is not news." },
  { id: "season", kind: "app", badge: 2, vh: 950,
    js: `view = { ...view, tab: "season", mode: "list", id: null, seasonSub: "", seasonQ: "", seasonSort: null, seasonDir: null }; render();`,
    title: "Season · the blueprint",
    note: "The Master Tracker sheet, in the app. One line per part the team means to make, most of them nearly empty by design \u2014 a line exists the moment somebody commits to building the thing, and the specifics arrive later. It is a read, and it is columnated: every line sits on the same eight fixed tracks, so subteam is under subteam and a deadline under a deadline and the way you read it is down a column rather than across a line. Name, subteam, layup type, the C/M/L rail the Parts index already draws, where the part has got to in a word, mold location, deadline, and who is on it. Empty cells stay empty and the header is what makes them legible. No sideways scroll at any width \u2014 thirteen editable columns had a floor near 1,700px against about 1,300px of room, so the old table scrolled at every width it was ever opened at; here the only track that can grow is the name, and it shrinks itself rather than pushing. The name opens the part, which is where everything is edited and where the evidence gate and both confirms already live." },
  { id: "workorders", kind: "app", badge: 3, vh: 1000,
  ...
  { id: "workorder-detail", kind: "app", badge: 4, vh: 1500,
  ...
  { id: "parts", kind: "app", badge: 5, vh: 1200,
  ...
  { id: "molds", kind: "app", badge: 6, vh: 1200,
  ...
  { id: "molds-overview", kind: "app", badge: 7, vh: 1100,
    js: `setTab("molds");`,
  ...
  { id: "inventory", kind: "app", badge: 8, vh: 1100,
  ...
  { id: "receiving", kind: "app", badge: 9, vh: 1000,
    js: `
      DB.items = [
  ...
  { id: "inventory-boards", kind: "app", badge: 9, vh: 1000,
  ...
  { id: "inventory-contents", kind: "app", badge: 9, vh: 1150,
  ...
  { id: "wo-issues", kind: "app", badge: 10, vh: 1200,
  ...
  { id: "cfd-panels", kind: "cfd", badge: 2, vh: 1000, view: "Panels",
  ...
  { id: "cfd-overlay", kind: "cfd", badge: 3, vh: 1000, view: "Overlay",
    dir: "07 CFD PDF Viewer/design",
  ...
  { id: "cfd-summary", kind: "cfd", badge: 4, vh: 1000, view: "Summary",
    dir: "07 CFD PDF Viewer/design",
