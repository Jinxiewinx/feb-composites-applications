...
![Figure 1. Datasheet demould figure (solid) against the FEB hold that governs (full bar), per system, on one time axis. The holds land on shift boundaries, which is why both FAST systems still hold 24 h.](figures/cs008-holds.png)
