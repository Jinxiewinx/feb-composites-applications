...
![Figure 1. The record graph for one job: the work order builds a part, points at a mold record, and consumes lots; a panel's coupons are suffixes, never records of their own. The rules under the boxes are §4.1's, drawn where they apply.](figures/cs013-records.png)
